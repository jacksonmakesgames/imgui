...
struct IMGUI_API ImGuiInputTextState
{
    ...
    bool                    SelectedAllMouseLock;   // after a double-click to select all, we ignore further mouse drags to resetScroll selection
...
struct ImGuiContext
{
    ...
    bool                    NavMousePosDirty;                   // When set we will resetScroll mouse position if (io.ConfigFlags & ImGuiConfigFlags_NavEnableSetMousePos) if set (NB: this not enabled by default)
